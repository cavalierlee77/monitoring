          ...
          <div class="row">
            <div class="col-12">
              <el-form-item label="用户机构">
                <el-select v-model="form.orgId" placeholder="用户机构">
                  <el-option
          ...
          <div class="row">
            <div class="col-12">
              <el-form-item label="用户角色">
                <el-select v-model="form.roleId" placeholder="用户角色">
                  <el-option
...
export default {
  ...
  computed: {
    ...mapState({
      bt: state =>
        state.BranchOfficeUserManagement.BranchOfficeUserManagementDataList,
  ...
  methods: {
    ...mapActions({
      getBranchOfficeUserManagementList: "getBranchOfficeUserManagementList",
