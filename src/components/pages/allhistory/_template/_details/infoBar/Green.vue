        ...
        <el-form ref="form" label-position="left" label-width="120px">
            ...
            <el-row>
            	<el-col :span="6">
    			    <div class="item_list">
    			        <label>审核结论</label>
    			        <el-input v-model="information.verifySuggestSelect" suffix-icon="el-icon-edit"></el-input>
    			    </div>
    			</el-col>
    			<el-col :span="6">
    			    <div class="item_list">
    			        <label>审核意见</label>
    			        <el-input v-model="information.verifySuggest" suffix-icon="el-icon-edit"></el-input>
    			    </div>
    			</el-col>
            </el-row>
        </el-form>
	...
	watch: {
		infoData:{
            handler(val, oldval) {
                ...
                this.information.verifySuggestSelect= val.verifySuggestSelect
                this.information.verifySuggest= val.verifySuggest
            },
            immediate: true,
            deep: true
        },
        ...
        information:{
        	handler(val, oldval){
        		this.$emit('changeInformation',{
            	    ...
            	    verifySuggestSelect: this.information.verifySuggestSelect,
            	    verifySuggest: this.information.verifySuggest,
        		})
        	},
        	immediate: true,
            deep: true
