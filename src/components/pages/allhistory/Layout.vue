...
<script>
  ...
  export default {
    ...
    components: {
      CarTabs: () =>
        import(/* webpackChunkName: "allhistory" */ "../../common/Tabs.vue"),
      iDialog: () =>
        import(
          /* webpackChunkName: "allhistory" */ "../../common/XuDialog.vue"
        ),
      XuPagination: () =>
        import(
          /* webpackChunkName: "allhistory" */ "../../common/XuPagination.vue"
        ),
      iTable: () =>
        import(/* webpackChunkName: "allhistory" */ "../../common/XuTable.vue"),
      GreenQb: () =>
        import(
          /* webpackChunkName: "allhistory" */ "./_template/_querybox/GreenQuerybox.vue"
        ),
      TruckQb: () =>
        import(
          /* webpackChunkName: "allhistory" */ "./_template/_querybox/TruckQuerybox.vue"
        ),
      CombineHarvQb: () =>
        import(
          /* webpackChunkName: "allhistory" */ "./_template/_querybox/CombineHarvQuerybox.vue"
        ),
      MilitaryQb: () =>
        import(
          /* webpackChunkName: "allhistory" */ "./_template/_querybox/MilitaryQuerybox.vue"
        ),
      DisasterQb: () =>
        import(
          /* webpackChunkName: "allhistory" */ "./_template/_querybox/DisasterQuerybox.vue"
        ),
      CheckedDetails: () =>
        import(
          /* webpackChunkName: "allhistory" */ "./_template/_details/Details"
        )
    },
    computed: {
      ...mapState({
        ...
        historydata: state => state.allhistory.allhistoryData,
        nowTab: state => state.allhistory.nowTab,
        tabType: state =>
          state.allhistory.nowTab
            ? state.allhistory.hisRelevance[state.allhistory.nowTab]
            : state.allhistory.hisRelevance.GreenCar,
        HeadList: state =>
          state.allhistory.nowTab
            ? state.allhistory[
                state.allhistory.hisRelevance[state.allhistory.nowTab].header
              ]
            : state.allhistory.GreenCarHeaderList
      }),
      page: function() {
    ...
    methods: {
      ...
      getHistoryData(val = {}) {
        ...
        this.cache = fm;
        this.$store.dispatch("getAllHistoryData", fm);
      },
      ...
      dialogToggle() {
        ...
        this.getHistoryData(this.cache);
      }
    },
    mounted() {}
  };
