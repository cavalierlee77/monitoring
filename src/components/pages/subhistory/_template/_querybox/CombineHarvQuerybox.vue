    ...
    <section>
        <el-form ref="form" label-width="70px">
            ...
            <el-row v-if="queryType">
                ...
                <el-col :span="7">
                    <el-form-item label="作业证号">
                        <el-input v-model="SelData.jobId" placeholder="请输入车牌号码" suffix-icon="el-icon-edit" class='el-input-a'></el-input>
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row v-if="queryType">
...
export default {
    ...
    methods: {
        ...
        datePickerChange: function(val, name) {
            this.$set(this.SelData, name, val);
        },
        ...
        checkQueryHei(){
            this.$emit('changeHei', 0, 'CombineHarvCar');
        },
        resetQueryData(){
            this.$set(this.SelData, 'examineType', '');
            this.$set(this.SelData, 'jobId', '');
