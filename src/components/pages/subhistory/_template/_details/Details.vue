...
<script>
  ...
  export default {
    ...
    components: {
      InputsBox: () => import(/* webpackChunkName: "subhistory" */ "./inputs"),
      PicMov: () =>
        import(
          /* webpackChunkName: "common" */ "../../../../common/preview/picpanel"
        ),
      Timeline: () =>
        import(
          /* webpackChunkName: "common" */ "../../../../common/timelinepanel"
        )
    },
    mounted() {},
    computed: {
      ...mapState({
        ...
        inputList: state => {
          const _type = state.subhistory.nowTab;
          let _inputList = "GreenCarInpRel";
          if (_type) {
            _inputList = state.subhistory.hisRelevance[_type].selRelevance;
          }
          return state.subhistory[_inputList];
        },
